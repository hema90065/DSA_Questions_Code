...
public class LinkedList {
    ...
    public void addFirst(int data) {
        ...
        // Step 2: Set newNode's next to current head
        newNode.next = head;
    ...
    public void addLast(int data) {
        ...
        // Step 1: Set current tail's next to newNode
        tail.next = newNode;

        // Step 2: Update tail to newNode
        tail = newNode;
    }
    ...
    public boolean checkPelindrome(){
        ...
        //Step3 - check right half is equal to left half
        Node right = prev;
        Node left = head;
